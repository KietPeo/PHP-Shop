...
<html lang="en-CA">
   ...
   <body>
         ...
         <div class="header_top_menu">
            <div class="header_top_menu_all">
               <div class="header_top">
                  <div class="bg_in">
                     <div class="logo">
                        <a href="."><img src="image/logohere.jpeg" width="250" height="100" alt="logohere.jpeg" /></a>
                     </div>
                     <nav class="menu_top">
                                 ...
                                 <div id='cssmenu_flyout' class="display_destop_menu">
                                    <ul>
                                       <li class='active has-sub'>
                                          <a href='sanpham.php'><span>Điện thoại</span></a>
                                       ...
                                       <li class='active has-sub'>
                                          ...
                                          <div class="menu_sub_all">
                                             ...
                                             <ul>
                                              ...
                                              <ul>
                                                <li>
                                                   <a href="sanpham.php">Ipad A7</a>
                                                </li>
                                                <li>
                                                   <a href="sanpham.php">Ipad A9</a>
                                                </li>
                                                <li>
                                                   <a href="sanpham.php">Ipad A10</a>
                                                </li>
                                                  <li>
                                                   <a href="sanpham.php">Ipad A7</a>
                                                </li>
      ...
      <script src="<?=BASE_URL?>/public/js/cloudzoom.js"></script>
                        ...
                        <div class="slider-galery ">
                         <div id="sync1" class="owl-carousel owl-theme">
                                  <div class="item">
                                    ...
                                    <div class="item">
                                      <img src="image/iphone1.jpg" width="100%">
                                  </div>
                                    ...
                                    <div class="item">
                                      <img src="image/iphonex.png" width="100%">
                                  </div>
                                  </div>
            ...
            <div class="bg_in">
               <div class="footer footer_bottom">
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           <li><a href="" class="fb"><img src="image/Fb.png">Facebook</a></li>
                           <li><a href="#2" class="fb"><img src="image/Fb.png">Google</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
