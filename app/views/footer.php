<footer>
   <div class="footer_top_bootom" style="background-color: beige;">
      <div class="bg_in">
         <div class="footer footer_bottom">
            ...
            <div class="footer-col">
               ...
               <div class="footer-col-content">
                  <ul class="social">
                     <li><a href="" class="fb"><img src="<?= BASE_URL ?>/public/images/Fb.png">Facebook</a></li>
                     <li><a href="#2" class="fb"><img src="<?= BASE_URL ?>/public/images/Fb.png">Google</a></li>
                  </ul>
                  <div class="clear"></div>
               </div>
            </div>
      ...
      <div class="bg_in">
         <div class="footer">
            <div class="infor_company">
               ...
               <a href=""><img src="<?= BASE_URL ?>/public/images/da-dang-ky-voi-bo-cong-thuong.png" alt="da-dang-ky-voi-bo-cong-thuong.png" class="cangiua" /></a>
...
<link async rel="stylesheet" href="<?= BASE_URL ?>/public/css/cssfooter.css" />
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>

<script defer type="text/javascript" src="<?= BASE_URL ?>/public/js/sweet-alert.js"></script>
<script defer type="text/javascript" src="<?= BASE_URL ?>/public/js/jquery.flexslider-min.js"></script>
<script defer src="<?= BASE_URL ?>/public/js/owl.carousel.js" type="text/javascript"></script>
<script defer src="<?= BASE_URL ?>/public/js/jquery.lazyload.min.js" type="text/javascript"></script>
<script defer type="text/javascript" src="<?= BASE_URL ?>/public/js/script_ex.js"></script>
<script defer type="text/javascript" src="<?= BASE_URL ?>/public/js/script_menu.js"></script>
